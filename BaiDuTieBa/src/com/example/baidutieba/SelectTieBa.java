			...
			gButton.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					...
					if (tiebaName == null || "".equals(tiebaName)) {
						new AlertDialog.Builder(SelectTieBa.this)
								.setTitle("Message")
								.setMessage("The keyword can not empty.")
								.setPositiveButton("OK", null).show();
					} else {
						try {
							tiebaName = java.net.URLEncoder.encode(keyWord
									.getText().toString(), "GB2312");
						} catch (UnsupportedEncodingException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
						tempName = tiebaName;
						AlertDialog.Builder br = new AlertDialog.Builder(
								SelectTieBa.this);
						br.setTitle("Wait for data....");
						br.setMessage("Wait for data......");
						alertDialog = br.create();
						alertDialog.show();
						new Thread() {
